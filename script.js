...
var curseimage = document.querySelector(".img");
...
gsap.fromTo(
  ...
  { opacity: .5, y: 100, scaleX: 0.6 }, // Starts hidden and shifted down by 100px
  {
    ...
    scrollTrigger: {
      ...
      end: "top 10%", // End animation at 30% in view
     
      duration:1 // Smooth scrolling effect
...
curseimage.addEventListener("mouseenter", function() {
...
curseimage.addEventListener("mouseleave", function() {
  cursor.innerHTML = '';
  gsap.to(cursor, {
    scale: 1, // Reduced duration to make recovery faster
    width: '3vw',
    height: '3vw',
    border: '.3vw solid #a8a29e',
    backgroundColor: 'transparent',
